...
class Snake(threading.Thread):
    ...
    def key_pressed(self,e):
        ...
        old_direction = {'Up': 0, 'Down': 1, 'Left': 2, 'Right': 3}
        new_direction = {'Up': 1, 'Down': 0, 'Left': 3, 'Right': 2}
        judge[new_direction[self.direction]] = True
        if not judge[old_direction[e.keysym]]:
            self.direction = e.keysym'''
